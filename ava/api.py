...
from ava.config import Config  # Credentials for the database connection
from ava.arithmetic import arithmetic_parse  # Submodule of Dragonfire to analyze arithmetic expressions
from ava.database import User, Notification  # Submodule of Dragonfire module that contains the database schema
...
def cmd(text):
    ...
    Combines the results of these methods into a single JSON document:
     ...
     - :func:`ava.api.tagger` method (**POS Tagging**)
     - :func:`ava.api.dependency_parser` method (**Dependency Parse**)
     - :func:`ava.api.entity_recognizer` method (**Named Entity Recognition**)
...
def math(text):
    """**Endpoint** to return the response of :func:`ava.arithmetic.arithmetic_parse` function.
...
def learn(text, user_id):
    """**Endpoint** to return the response of :func:`ava.learn.Learner.respond` method.
...
def omni(text, gender_prefix):
    """**Endpoint** to return the answer of :func:`ava.omniscient.Omniscient.respond` method.
...
def deep(text, gender_prefix):
    """**Endpoint** to return the response of :func:`ava.deepconv.DeepConversation.respond` method.
...
def answer(text, gender_prefix, user_id, previous=None):
    ...
    Combines the results of these methods into a single JSON document:
     ...
     - :func:`ava.arithmetic.arithmetic_parse` function
     - :func:`ava.learn.Learner.respond` method
     - :func:`ava.omniscient.Omniscient.respond` method
     - :func:`ava.deepconv.DeepConversation.respond` method
...
class Run():
    ...
    def __init__(self, nlp_ref, learner_ref, omniscient_ref, dc_ref, coref_ref, userin_ref, reg_key, port_number, db_session_ref, dont_block=False):
        """Initialization method of :class:`ava.api.Run` class
        ...
        Args:
            ...
            learner_ref:            :class:`ava.learn.Learner` instance.
            omniscient_ref:         :class:`ava.omniscient.Omniscient` instance.
            dc_ref:                 :class:`ava.deepconv.DeepConversation` instance.
            userin_ref:             :class:`ava.utilities.TextToAction` instance.
