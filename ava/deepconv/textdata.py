...
from ava.deepconv.corpus.cornelldata import CornellData
from ava.deepconv.corpus.opensubsdata import OpensubsData
from ava.deepconv.corpus.scotusdata import ScotusData
from ava.deepconv.corpus.ubuntudata import UbuntuData
from ava.deepconv.corpus.lightweightdata import LightweightData
...
class TextData:
    ...
    def _constructBasePath(self):
        ...
        path = dirName = "/usr/share/ava/deepconv/model-pretrainedv2/"
