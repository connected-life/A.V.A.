...
class SystemTrayIcon:
    ...
    def __init__(self):
        """Initialization method of :class:`ava.stray.SystemTrayIcon` class.
        """
...
def SystemTrayInit():
    """Method to create a :class:`ava.stray.SystemTrayIcon` instance with the purpose of displaying to system tray icon.
    """
