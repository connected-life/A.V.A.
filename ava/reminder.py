...
class Reminder():
    ...
    def __init__(self):
        """Initialization method of :class:`ava.reminder.Reminder` class.
        """
        # self.userin = userin

    def check_time(self, now_timestamp, reminde_time_stamp):
        """Method to ava's command structures of searching in youtube ability.
    ...
    def remind(self, note_taker, userin, user_prefix, user_answering_note):
        ...
        while True:
            ...
            if not is_there_active:   # if there is no active reminder, loop will be interrupted.
                break  # thread will interrupted here.
            time.sleep(60)
