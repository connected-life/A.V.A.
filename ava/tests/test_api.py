...
import ava
import ava.api as API
from ava.database import Base
...
ava.learner.db_session = db_session
ava.learner.is_server = True

api_ref = API.Run(ava.nlp, ava.learner, ava.omniscient, ava.dc, ava.coref, ava.userin, REG_KEY, PORT, db_session, dont_block=True)
time.sleep(5)
