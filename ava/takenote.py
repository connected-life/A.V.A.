...
from ava.database import NotePad  # Submodule of Dragonfire module that contains the database schema
...
class NoteTaker():
    ...
    def __init__(self):
        """Initialization method of :class:`ava.takenote.NoteTaker` class.
        """
